import { ArrowLeft, ArrowUpRight, ChevronDown, Copy, GitBranch, Heart, MessageCircle, QrCode, X } from "lucide-react";
    ...
    <div className={view === "main" ? "about-dialog-layer" : "about-dialog-layer about-dialog-layer-has-child"}>
      ...
      >
        <header className="about-dialog-header">
          ...
          <button className="about-dialog-icon-button about-dialog-close" type="button" aria-label="关闭关于并返回设置" onClick={onClose}>
            <X size={18} />
          </button>
        </header>
      ...
      {view !== "main" ? (
        <div className="about-dialog-layer about-dialog-subview-layer">
          <div className="about-dialog-backdrop about-dialog-subview-backdrop" aria-hidden="true" onClick={() => setView("main")} />
          <section
            ref={childDialogRef}
          ...
          >
            <header className="about-dialog-header">
              <button className="about-dialog-icon-button" type="button" aria-label="返回关于" autoFocus onClick={() => setView("main")}>
                <ArrowLeft size={18} />
              </button>
              <div>
              ...
              <button className="about-dialog-icon-button about-dialog-close" type="button" aria-label="关闭当前页面并返回关于" onClick={() => setView("main")}>
                <X size={18} />
              </button>
            </header>
